...
export default function SidebarRecruiter({ isOpen, onClose, logo, companyName }: SidebarRecruiterProps) {
  ...
  return (
    <aside 
      className={`fixed md:sticky md:top-0 inset-y-0 left-0 z-50 flex flex-col bg-white border-r border-slate-200/85 text-slate-800 h-screen shrink-0 font-sans transition-all duration-300 ease-in-out md:transition-all ${
        isOpen 
          ? "w-64 translate-x-0" 
